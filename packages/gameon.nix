...
#   proton-ge     — Proton-GE extra compat tool for Steam
#   launchers     — Lutris, Heroic, Faugus, UMU launcher, Oversteer
#   overlays      — MangoHud, GOverlay, vkBasalt, vulkan-tools, mesa-demos
#   peripherals   — Piper (mouse), xone/xpadneo/hid-tmff2 packages, OpenTabletDriver
#   streaming     — Full GStreamer codec pack + noisetorch
#
# Hardware services (gameon.nix module):
#   openrgb / input-remapper / fanatec-wheel / logitech-wheel
#
# =============================================================================
{ pkgs, features }:
...
++ (pkgs.lib.optionals (go && gameon.overlays) (with pkgs; [
...
# ── Peripheral tools ─────────────────────────────────────────────────────────
++ (pkgs.lib.optionals (go && gameon.peripherals) (with pkgs; [
...
++ (pkgs.lib.optionals (go && gameon.streaming) (with pkgs; [
  gst_all_1.gstreamer
