# os-release.nix — NixOwOS os-release module (upstream reference asset)
# Source: https://github.com/yunfachi/NixOwOS/blob/master/src/os-release.nix
# License: MIT (yunfachi/NixOwOS)
#
# This file is kept as a reference only.
# The equivalent logic (without the delib/denix dependency) lives in
# modules/uwu/nixowos.nix and is applied automatically when features.uwu = true.
# Disabling features.uwu reverts system.nixos.* to NixOS defaults.
{
  delib,
  lib,
  ...
